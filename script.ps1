...
$vmobject | Add-VMGpuPartitionAdapter
...
$vmobject | Set-VM -GuestControlledCacheTypes 1 -LowMemoryMappedIoSpace 1Gb -HighMemoryMappedIoSpace 32GB 
Write-host "Done"
if ($scriptWritten) {
